...
include(
    ...
    ":samples:hello-workflow-multiplatform",
    ":samples:hello-workflow-multiplatform:shared",
    ":samples:hello-workflow-multiplatform:android",
    ":samples:hello-workflow-multiplatform:browser",
